...
public class RomanNumeral {
    ...
    /**
     * Return the standard Roman numeral representation of given integer.
     * 
     * @param i Integer value to convert Romen Numeral
     * @return Roman Numeral
     */
    public static String integerToRomanNumeral( Integer i ){
        RomanNumeral instance = new RomanNumeral( i );
