...
/**
 * ContextRoot altındaki bütün folderları da tarayarak documanları listeler.
 * 
 * FIXME: İyi bir filre sistemi lazım.
 * 
 * @author oyas
 */
@Named
@GroupedConversationScoped
public class UnifiedAttachmentWidget implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(UnifiedAttachmentWidget.class);
