...
public class ThemeManager implements Serializable {
    ...
    private String passwordrenewalTemplate;
    ...
    public void init() {
        ...
        passwordrenewalTemplate = templateCheckOrFallback(layoutName, "passwordrenewalTemplate.xhtml");
    ...
    public String getPasswordrenewalTemplate() {
        return passwordrenewalTemplate;
    }

    public void setPasswordrenewalTemplate(String passwordrenewalTemplate) {
        this.passwordrenewalTemplate = passwordrenewalTemplate;
    }
